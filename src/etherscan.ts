...
export const getEtherscanLink = (chainId: CHAINS, hash: string, entity: EtherscanEntities): string => {
...
export const getEtherscanTokenLink = (chainId: CHAINS, hash: string): string => {
  return getEtherscanLink(chainId, hash, ETHERSCAN_ENTITIES.Token)
}

export const getEtherscanAddressLink = (chainId: CHAINS, hash: string): string => {
